...
public class FreezeBox{
	
	
	private int yGridPos;
	private int xGridPos;
	private int[][] intMap;
	private static final int RESPAWN_INTERVAL = 30; //this is in seconds
	
	public FreezeBox(int yGridPos, int xGridPos, int[][] intMap){
